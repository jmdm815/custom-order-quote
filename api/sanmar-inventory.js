...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!xml.includes('errorOccurred>false')) {
      return res.status(200).json({ qty: null, error: 'invalid product' });
    }
